...
const SAYINGS = {
  fire: {
    ...
    decoy: [
      "Meet my stunt double!",
      "He's the handsome one.",
      "Two of us now. Panic accordingly.",
      "Shoot THAT guy. He's suspicious.",
      "It's inflatable AND expendable.",
    ],
    grapple: [
      "Get over here!",
      "Come closer. I insist.",
      "Personal space is a privilege, not a right.",
      "You've been voluntold to relocate.",
      "Free towing service, no consent required.",
    ],
    ice: [
      "Chill out. Permanently.",
      "Ice to meet you!",
      "Winter delivered, express freight.",
      "The floor is friendship-free AND frictionless.",
      "Skating rink, compliments of the house.",
    ],
    quake: [
      "Let's shake things up!",
      "Richter? I hardly know 'er!",
      "Earthquake insurance: also not covering this.",
      "The ground has opinions now.",
      "Tectonic tantrum, incoming!",
    ],
    teleport: [
      "See you on the other side. Literally me.",
      "Location is a state of mind.",
      "I hate long commutes.",
      "Physics called in sick today.",
      "BAMF! ...That's the sound it makes.",
    ],
    acid: [
      "Umbrella won't save you.",
      "Today's forecast: pH 1.",
      "Singing in the rain? Not this rain.",
      "Corrosion is just spicy weather.",
      "Acid-washed, tank edition.",
    ],
    emp: [
      "Lights out, tin man.",
      "Have you tried turning it off? I have.",
      "Your electronics called. Briefly.",
      "Analog beats digital, sucker!",
      "Unplugged: the live experience.",
    ],
    carpet: [
      "Air support, on the house!",
      "One rug of ruin, coming down!",
      "The sky is falling. In segments.",
      "Bombs away! And away. And away.",
      "Wall-to-wall coverage, literally.",
    ],
    meteor: [
      "The dinosaurs send their regards.",
      "Sky's out, rocks out!",
      "Make a wish! Make several!",
      "Astronomy is a contact sport now.",
      "Everything must go. From orbit.",
    ],
    refund: [
      "This seemed like a bargain...",
      "One dollar. What could go wrong?",
      "Fingers crossed, everyone!",
      "As-is, no warranty, FIRE!",
      "Money well... spent?",
    ],
  },
